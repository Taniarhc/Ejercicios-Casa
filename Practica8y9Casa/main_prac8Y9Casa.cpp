...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_tapiz.LoadTGA("tapiz_silla.tga");
	t_tapiz.BuildGLTexture();
	t_tapiz.ReleaseImage();
}
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		glPushMatrix();
		glColor3f(1.0, 1.0, 1.0);
		glTranslatef(-1.25, -0.5, 3.5);
		glScalef(0.5, 2.0, 0.5);
		prisma2(t_madera.GLindex);
		glPopMatrix();
		...
		prisma3(t_tapiz.GLindex, t_madera.GLindex);
		glDisable(GL_ALPHA_TEST);
		glPopMatrix();

		glPushMatrix();// respaldo
		glColor3f(1.0, 1.0, 1.0);
		glTranslatef(4,0.5,-0.625);
		glRotatef(90,1,0,0);
		glScalef(1, 0.25, 2.25);
		glEnable(GL_ALPHA_TEST);
		glAlphaFunc(GL_GREATER, 0.1f);
		prisma3(t_tapiz.GLindex, t_madera.GLindex);
		glDisable(GL_ALPHA_TEST);
		...
		glPushMatrix();// p1
		glColor3f(1.0, 1.0, 1.0);
		glTranslatef(3.625, -1.375, 0.375);
		...
		glPushMatrix();// p2
		glColor3f(1.0, 1.0, 1.0);
		glTranslatef(3.625, -1.375, -0.625);
		glScalef(0.25, 1.5, 0.25);
		prisma2(t_madera.GLindex);
		glPopMatrix();
		...
		glPushMatrix();// p3
		glColor3f(1.0, 1.0, 1.0);
		glTranslatef(4.375, -1.375, 0.375);
		glScalef(0.25, 1.5, 0.25);
		prisma2(t_madera.GLindex);
		glPopMatrix();
		...
		glPushMatrix();// p4
		glColor3f(1.0, 1.0, 1.0);
		glTranslatef(4.375, -1.375, -0.625);
		glScalef(0.25, 1.5, 0.25);
		prisma2(t_madera.GLindex);
		glPopMatrix();
